...
class MockFirestoreService extends Mock implements FirestoreService {
  ...
  Stream<QuerySnapshot> getMyAppointments(String userId) {
    ...
    final docs = [
      ...
      _getMockDocumentSnapshot(cancelledAppointment),
    ];
...
void main() {
  testWidgets('MyAppointmentsScreen shows upcoming, past, and cancelled appointments', (WidgetTester tester) async {
    ...
    expect(find.text('Higienização'), findsOneWidget);
    expect(find.text('Status: Cancelado'), findsOneWidget);
  });
}
